...
window.BonziData = {
	...
	sprite: {
		...
		animations: {
			...
			surf_intro: [...range(277, 302), "idle"],
			surf_away: range(16, 39),

			shrug_fwd: [...range(40, 50), "shrug_still"],
			shrug_still: [50],
			shrug_back: [...range(50, 40), "idle"],

			earth_fwd: [...range(51, 57), "earth_still"],
			earth_still: [...range(58, 80), "earth_still"],
			earth_back: [...range(81, 86), "idle"],

			cool_fwd: [...range(108, 124), "cool_still"],
			cool_still: [125],
			cool_back: [...range(124, 108), "idle"],

			praise_fwd: [...range(159, 163), "praise_still"],
			praise_still: [164],
			praise_back: [...range(163, 159), "idle"],

			grin_fwd: [...range(182, 189), "grin_still"],
			grin_still: [184],
			grin_back: [...range(184, 182), "idle"],

			backflip: [...range(331, 343), "idle"]
		}
	},
	to_idle: {
